...
public class SendLocationHolder$$ViewBinder<T extends cn.bmob.imdemo.adapter.SendLocationHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131493025, "field 'layout_location'");
    target.layout_location = finder.castView(view, 2131493025, "field 'layout_location'");
    view = finder.findRequiredView(source, 2131493002, "field 'tv_location'");
    target.tv_location = finder.castView(view, 2131493002, "field 'tv_location'");
