...
public class SendVoiceHolder$$ViewBinder<T extends cn.bmob.imdemo.adapter.SendVoiceHolder> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131493028, "field 'tv_voice_length'");
    target.tv_voice_length = finder.castView(view, 2131493028, "field 'tv_voice_length'");
    view = finder.findRequiredView(source, 2131493027, "field 'iv_voice'");
    target.iv_voice = finder.castView(view, 2131493027, "field 'iv_voice'");
