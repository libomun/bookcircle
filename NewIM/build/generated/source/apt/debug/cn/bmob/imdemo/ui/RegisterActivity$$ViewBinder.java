...
public class RegisterActivity$$ViewBinder<T extends cn.bmob.imdemo.ui.RegisterActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131492964, "field 'btn_register' and method 'onRegisterClick'");
    target.btn_register = finder.castView(view, 2131492964, "field 'btn_register'");
    ...
    view = finder.findRequiredView(source, 2131492963, "field 'et_password_again'");
    target.et_password_again = finder.castView(view, 2131492963, "field 'et_password_again'");
  }
