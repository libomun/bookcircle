...
public class SearchUserActivity$$ViewBinder<T extends cn.bmob.imdemo.ui.SearchUserActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131492966, "field 'et_find_name'");
    target.et_find_name = finder.castView(view, 2131492966, "field 'et_find_name'");
    ...
    view = finder.findRequiredView(source, 2131492967, "field 'btn_search' and method 'onSearchClick'");
    target.btn_search = finder.castView(view, 2131492967, "field 'btn_search'");
